...
def getFollowedSeries(followfile):
    file = open(followfile, mode='r')
    series = []
    for i in file:
        series.append(i.replace('\n', ''))
    return series
...
if __name__ == "__main__":
    def parseArgs():
        ...
        parser.add_argument('-r', '--rssfeed',
                            ...
                            required=True,
                            type=str)
        parser.add_argument('-f', '--followfile',
                            help='text file containing MU links',
                            required=True,
                            type=str)
    ...
    def main():
        ...
        oldrssfeed = []
        cache = []
        currentrssfeed = [i for i in curateRssFeed(followfile, rssfeed)]
        if cachefile != "":
